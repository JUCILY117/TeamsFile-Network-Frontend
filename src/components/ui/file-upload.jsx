    ...
    (<div className="w-full" {...getRootProps()}>
      <motion.div
        ...
        <div className="flex flex-col items-center justify-center">
          <p
            className="relative z-20 font-sans font-bold text-neutral-300 dark:text-neutral-300 text-base">
            Upload file
          </p>
          <p
            ...
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  ...
                  <div
                    className="flex text-sm md:flex-row flex-col items-start md:items-center w-full mt-2 justify-between text-neutral-400 dark:text-neutral-400">
                    <motion.p
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      layout
...
export function GridPattern() {
  ...
  return (
    (<div
      className="flex bg-neutral-900 dark:bg-neutral-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
            ...
            (<div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ...
                  : "bg-neutral-950 dark:bg-neutral-950 shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset] dark:shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset]"
              }`} />)
          );
        }))}
    </div>)
